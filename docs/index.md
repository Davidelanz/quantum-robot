...
<div align="center" style="align:center; padding:20px; line-height:2;">
   ...
   <a href="https://snyk.io/advisor/python/quantum-robot">
      <img src="https://img.shields.io/badge/Snyk_Security-blue" alt="snyk">
   </a>
...
The package exploits <a href="https://qiskit.org/">Qiksit</a> framework, implementing the models on
quantum circuits which can be simulated on a classical computer or sent to a quantum
backend (service provided by <a href="https://quantum-computing.ibm.com/">IBM Quantum Experience</a>).
...
<a href="https://scholar.google.com/citations?user=Lqx6VqEAAAAJ">Davide Lanza</a>
as a Master thesis research, with the help of
<a href="https://www.dibris.unige.it/mastrogiovanni-fulvio">Fulvio Mastrogiovanni</a>
and
<a href="http://www.spin.cnr.it/index.php/people/46-researchers/49-solinas-paolo.html">Paolo Solinas</a>.
